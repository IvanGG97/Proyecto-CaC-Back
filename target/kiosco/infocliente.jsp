...
<body>
    ...
    <main class="container d-flex justify-content-between gap-2 mt-2">
        <div class="col-4 h-100 d-flex align-self-center">
            <img src="https://offers.hubspot.es/hubfs/Plantilla%20de%20tipos%20de%20cliente-ILUSTRACION%20(1062).png" alt="" style="width:100%;transform: rotatey(180deg);">
        </div>
        <section class="col-4 align-self-center">
            <table class="border border-dark w-100 rounded-2">
                    ...
                    <tr  class="border border-dark">
                        <td  class="border border-dark">${c.getId()}</td>
                        <td  class="border border-dark">${c.getNombre()}</td>
                        <td  class="border border-dark">${c.getApellido()}</td>
                        <td  class="border border-dark">${c.getContacto()}</td>
                    </tr>
            </table>
        ...
        <div class="col-4 h-100 d-flex align-self-center">
            <img src="https://offers.hubspot.es/hubfs/Plantilla%20de%20tipos%20de%20cliente-ILUSTRACION%20(1062).png" alt="" style="width: 100%;">
        </div>
    </main>
